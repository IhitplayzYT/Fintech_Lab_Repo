...
@SQLDelete(sql =
 "UPDATE customer_proof_of_id SET crud_flag='D' WHERE customer_identifier=?")
...
private String customer_proof_of_id_type;
private String customer_proof_of_id_value;
...
@ManyToOne
@JoinColumn(name = "customer_proofofid_detail_FK")
...
public String getCustomer_proof_of_id_type() {
    return customer_proof_of_id_type;
}

public void setCustomer_proof_of_id_type(String customer_proof_of_id_type) {
    this.customer_proof_of_id_type = customer_proof_of_id_type;
}

public String getCustomer_proof_of_id_value() {
    return customer_proof_of_id_value;
}

public void setCustomer_proof_of_id_value(String customer_proof_of_id_value) {
    this.customer_proof_of_id_value = customer_proof_of_id_value;
}
