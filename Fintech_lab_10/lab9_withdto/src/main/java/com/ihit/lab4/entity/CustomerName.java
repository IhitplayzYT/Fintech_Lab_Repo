...
@SQLDelete(sql =
 "UPDATE customer_name SET crud_flag='D' WHERE customer_identifier=?")
public class CustomerName {
@Id
@GeneratedValue(strategy = GenerationType.IDENTITY)
private Long customer_identifier;

private String customer_name_type;
private String customer_name_value;
...
@ManyToOne
@JoinColumn(name = "customer_name_detail_FK")
...
public String getCustomer_name_type() {
    return customer_name_type;
}

public void setCustomer_name_type(String customer_name_type) {
    this.customer_name_type = customer_name_type;
}

public String getCustomer_name_value() {
    return customer_name_value;
}

public void setCustomer_name_value(String customer_name_value) {
    this.customer_name_value = customer_name_value;
}
