...
@SQLDelete(sql =
 "UPDATE customer_identification SET crud_flag='D' WHERE customer_identifier=?")
public class CustomerIdentification{
@Id
@GeneratedValue(strategy = GenerationType.IDENTITY)
private Long customer_identifier;
private String customer_identification_type;
...
@OneToOne
@JoinColumn(name = "customer_identification_detail_FK",nullable = false)
...
public String getCustomer_identification_type() {
    return customer_identification_type;
}

public void setCustomer_identification_type(String customer_identification_type) {
    this.customer_identification_type = customer_identification_type;
}
...
public void setCustomer_identification_item(String customer_identification_item) {
    this.customer_identification_item = customer_identification_item;
}
