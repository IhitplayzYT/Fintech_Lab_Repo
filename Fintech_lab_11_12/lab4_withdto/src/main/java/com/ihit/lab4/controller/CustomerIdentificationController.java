...
public class CustomerIdentificationController {
  ...
  public CustomerIdentificationController(
      CustomerIdentificationService service) {
    this.service = service;
  }

  @GetMapping("/page")
  public Page<CustomerIdentificationDTO> getPage(@RequestParam int page,
  ...
  create(@RequestBody CustomerIdentificationDTO dto) {
  ...
  @PutMapping("/{id}")
  public CustomerIdentificationDTO
  update(@PathVariable Long id, @RequestBody CustomerIdentificationDTO dto) {
