...
public class CustomerNameController {
  ...
  @GetMapping("/page")
  public Page<CustomerNameDTO> getPage(@RequestParam int page,
  ...
  @PostMapping
  public CustomerNameDTO create(@RequestBody CustomerNameDTO d) {
    return service.create(d);
  }

  @GetMapping("/{id}")
  public CustomerNameDTO get(@PathVariable Long id) {
    return service.getById(id);
  }

  @PutMapping("/{id}")
  public CustomerNameDTO update(@PathVariable Long id,
                                @RequestBody CustomerNameDTO d) {
